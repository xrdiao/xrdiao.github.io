...
My research interest includes robot navigation and manipulation, reinforcement learning, and contact dynamics. I have published more than 3 papers at the top international conferences with total [![Google Scholar citations](https://img.shields.io/endpoint?url=https://scholar-citations.vercel.app/api/citations?user=kX-y4IoAAAAJ&logo=Google%20Scholar&label=citations&color=9cf)](https://scholar.google.com/citations?user=kX-y4IoAAAAJ)
